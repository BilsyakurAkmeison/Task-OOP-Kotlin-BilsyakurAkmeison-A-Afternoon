...
class Hero {
    ...
    fun lari() {
        checkHealth()
        println("$name berlari di lapangan...")
        health -= 2
    }

    fun makan() {
        checkHealth()
        println("$name makan mie ayam...")
        health += 2
    }

    fun minum() {
        checkHealth()
        println("$name minum air putih...")
        health += 2
    }

    fun lompat() {
        checkHealth()
        println("$name sedang melompat-lompat...")
        health -= 2
    }

    fun duduk() {
        checkHealth()
        println("$name duduk beristirahat sejenak...")
        health += 1
    }
