...
fun main() {
    ...
    hero.setProfile("Bilsyakur Akmeison", 20, 170)
    ...
    **/
    ...
    hero.lari()   // -2
    hero.lompat()    // -2
    hero.jalan()    // -1 = 20-7 = 13
    // 3 jalan, 1 lari, 1 lompat

    // Istirahat sejenak
    hero.duduk()    // +1
    hero.makan()    // +2 = 13+3 = 16
    // 1 duduk (done), 1 makan (done)

    // Activity 2
    hero.jalan()    // -1
    hero.lari()     // -2
    hero.lompat()   // -2
    hero.lompat()    // -2 = 16-7 = 9
    // 1 jalan (total 4), 1 lari (done), 2 lompat.
